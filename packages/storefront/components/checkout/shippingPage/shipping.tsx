...
const Shipping = () => {
  return (
    <>
      <div className="px-3.5 m-0 lg:mx-10 lg:my-12">
        {/* <Path
                    cart={path.cart}
                    info={path.info}
        ...
        <div className="box-border p-4 border-2 mt-10 divide-y-2 rounded-md text-center mx-auto">
          <div className="flex justify-between items-center p-4">
            ...
            <a href="https://seinfeldquotes.com" className="ml-10 text-xs">
              Change
            </a>
          </div>
          ...
          <div className="flex justify-between items-center p-4">
            <div className="flex flex-wrap gap-4">
              ...
              <p className="text-xs">Kalachandpur Gulshan Dhaka-1212</p>
            </div>
            <a href="https://seinfeldquotes.com" className="ml-10 text-xs">
              Change
            </a>
