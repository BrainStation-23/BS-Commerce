    ...
    <div className="2xl: grid h-72 items-center sm:h-72 md:h-72 lg:h-80 xl:h-96 2xl:h-96">
      ...
      <div className="container z-10 mx-auto text-center font-[sans-serif] md:pl-8 md:text-left  lg:pt-4 xl:pl-4 ">
        ...
        <div className="mt-3 lg:mt-8">
          <button className="left-0 rounded-lg bg-primary py-2 px-4 text-xs font-bold uppercase text-white hover:bg-neutral-700 sm:text-xs md:text-sm xl:text-base">
            Read More
          </button>
        </div>
      </div>
