...
const Breadcrumb: React.FC<Props> = (props) => {
  ...
  return (
    <div className="p-9 h-48 sm:p-5 md:p-12 lg:p-14 xl:p-14 bg-[url('https://cdn.shopify.com/s/files/1/0359/6350/2651/files/banner18.jpg?v=1588133916')] bg-cover bg-no-repeat bg-center">
