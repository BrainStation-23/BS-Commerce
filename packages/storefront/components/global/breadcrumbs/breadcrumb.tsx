...
const Breadcrumb: React.FC<Props> = (props) => {
  ...
  return (
    <div className="h-48 bg-[url('https://cdn.shopify.com/s/files/1/0359/6350/2651/files/banner18.jpg?v=1588133916')] bg-cover bg-center bg-no-repeat p-9 dark:text-black sm:p-5 md:p-12 lg:p-14 xl:p-14">
