  ...
  return (
    ...
    >
      <input
        ...
        id="navSearchInput"
      />
      <div className="flex h-12 w-14 cursor-pointer justify-center rounded-r-full bg-primary dark:bg-dark_primary transition-all duration-200 ease-linear hover:bg-stone-900">
        <button
          type="submit"
          id="navSearchSubmit"
          className=""
    ...
    // >
    //   <input
    //     className="z-[-1] w-full bg-white py-4 pl-4 focus:outline-none"
    //     type="search"
    //     name="search"
    //     placeholder={`${props.placeholder}`}
    //     id="navSearchInput"
