...
const Drawer: React.FC<Props> = ({ drawer, closeDrawer }: Props) => {
  ...
  return (
    ...
    >
      <div className="">
        <div className="">
          <button className="mr-4 text-primary" onClick={() => closeDrawer()}>
            <ChevronLeftIcon />
          </button>
          <span className="text-3xl font-medium text-primary">BS Commerce</span>
        </div>
      ...
      <button
        className="w-full rounded-full border-2 border-green-600 py-2 text-primary"
