      ...
      <div className="grid lg:row-span-2 xl:row-span-2">
        <div className="max-w-xl  overflow-hidden shadow-lg">
          <div className="bg-black w-full">
            <div className="text-white px-4 py-1 text-base font-medium">
              CART TOTALS
            </div>
          </div>
          <div className="p-6 flex justify-center">
            <table className="border-collapse border border-slate-400">
              <tbody>
                <tr>
                  <td className="border border-slate-300 px-4 md:px-6 xl:px-8 ml-20 py-5">
                ...
                <tr>
                  <td className="border border-slate-300 px-8 ml-20 py-5">
