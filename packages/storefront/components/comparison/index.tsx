      ...
      {showModal ? (
        <>
          <div className="fixed inset-0 z-50 flex justify-center bg-zinc-200 bg-opacity-80">
            <div className="relative my-auto mx-auto overflow-x-auto md:overflow-x-hidden overflow-y-auto md:w-3/4">
                    ...
                    <div className="overflow-x-auto overflow-y-auto sm:-mx-6 lg:-mx-8">
                      <div className="inline-block py-2 sm:px-6 lg:px-8">
                        <div className="overflow-hidden">
                          <table className="border text-center md:table-fixed w-full">
