      ...
      <div className="rounded-full bg-white p-2 text-center drop-shadow-md">
        ...
        <span className="" id="addToCartIconID">
          ...
          >
            ...
            <div className="-ml-7 -mt-2 h-3 w-3 rotate-45 bg-zinc-900"></div>
          </div>
        </span>
        {/* </Link> */}
        ...
        <span>
          ...
          <div className="absolute left-3 -top-7 mb-6 hidden flex-col items-center peer-hover:flex">
            ...
            <div className="-mt-2 -ml-2 h-3 w-3 rotate-45 bg-zinc-900"></div>
          </div>
        </span>
        ...
        <Link href={token ? `/` : `/account/sign-in`} passHref>
          <span>
            ...
            >
              <span
                id="addToWishList"
                className="whitespace-no-wrap z-10 w-full rounded-md bg-zinc-900 p-[6px] text-sm leading-none text-white shadow-lg"
              >
        ...
        <Link href="/" passHref>
          <span>
            ...
            <div className="absolute left-4 -top-7 mb-6 hidden items-center peer-hover:inline-block">
              <span className="whitespace-no-wrap relative z-10 rounded-md bg-zinc-900 p-[6px] text-sm leading-none text-white shadow-lg">
                Add to compare
                <div className="absolute right-4 -bottom-1 -mt-2 h-3 w-3 rotate-45 bg-zinc-900"></div>
              </span>
            </div>
          </span>
        </Link>
