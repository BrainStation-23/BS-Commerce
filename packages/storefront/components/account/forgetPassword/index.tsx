...
const ForgotPassword: NextComponentType = () => {
  const [submitButtonState, stateSubmitButtonState] =
        ...
        >
          ...
          <div className="m-5 my-3 sm:m-5 md:mx-10 lg:mx-10 xl:mx-10">
            {submitButtonState === 'username' && (
              <UsernameForm stateSubmitButtonState={stateSubmitButtonState} />
            )}

            {submitButtonState === 'otp' && (
              <OtpForm stateSubmitButtonState={stateSubmitButtonState} />
            )}
