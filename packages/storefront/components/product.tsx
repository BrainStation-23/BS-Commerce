                                ...
                                <div className="rounded overflow-hidden shadow-lg max-w-sm">
                                    <div className="relative">
                                        <div className="relative w-96 h-60  text-white overflow-hidden cursor-pointer transition-all duration-700">
                                            <div className="absolute inset-0 w-full h-full flex justify-center items-center bg-white transition-all duration-700 delay-400 z-20 hover:opacity-0">
                                                <Image
                                                    src={img1}
                                                    alt="laptop"
                                                    className="h-10 w-10"
                                        ...
                                        <div className="group text-center bg-white mb-10 px-0.5 py-0.5 rounded-2xl">
                                            <div className="absolute text-red hidden group-hover:block  mx-11">
                                                <svg
