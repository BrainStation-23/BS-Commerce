...
const Currency: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <ul
        className={`absolute top-8 z-50 w-40 overflow-y-auto whitespace-nowrap border bg-white p-4 text-gray-700 transition-all duration-500 ease-linear dark:bg-dark_bg dark:text-dark_text lg:top-7 lg:w-60 ${'left-0'} ${
          open
