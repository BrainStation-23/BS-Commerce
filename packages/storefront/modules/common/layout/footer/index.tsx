      ...
      <div className="mb-20 flex flex-col items-center gap-y-10 px-4 md:mb-0 md:flex-row md:flex-wrap md:items-start lg:w-full lg:px-0">
        ...
        <div className="flex flex-col text-center md:flex-1 md:grow-[2] md:text-left">
          ...
          >
            ...
            />
            <button className="mr-[-2px] flex h-12 w-24  cursor-pointer justify-center rounded-r-full bg-primary p-4 text-white transition-all duration-200 ease-linear hover:bg-stone-900 dark:bg-dark_primary">
              {t('common:subscribe')}
