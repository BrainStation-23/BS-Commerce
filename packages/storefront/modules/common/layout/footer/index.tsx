      ...
      <div className="container mx-auto mb-3 flex justify-center px-4 py-4 lg:py-16">
        <div className="mb-20 flex flex-col items-center gap-y-10 px-4 md:mb-0 md:flex-row md:flex-wrap md:items-start lg:w-full lg:px-0">
          ...
          <div className="flex flex-col text-center md:flex-1 md:grow-[2] md:text-left">
            ...
            <div
              className={`flex h-12 w-full flex-row items-center justify-between rounded-full border border-slate-200 text-center text-sm dark:bg-white dark:text-black`}
            >
              <input
              ...
              />
              <button className="flex h-12 w-28 cursor-pointer justify-center rounded-r-full bg-primary p-[14px] text-center text-white transition-all duration-200 ease-linear hover:bg-stone-900 dark:bg-dark_primary">
                {t('common:subscribe')}
