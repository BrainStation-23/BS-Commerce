...
export declare abstract class ICartDatabase {
    abstract isCartExist: (userId: string) => Promise<Cart | null>;
    abstract isItemExist: (userId: string, productId: string) => Promise<Cart | null>;
    abstract addItem: (userId: string, item: Item) => Promise<Cart | null>;
    abstract getCartProduct: (cart: Cart) => Promise<Cart | null>;
    abstract incrementItemQuantity: (userId: string, item: Item) => Promise<Cart | null>;
    ...
    abstract deleteCartItem: (userId: string, productId: string) => Promise<Cart | null>;
