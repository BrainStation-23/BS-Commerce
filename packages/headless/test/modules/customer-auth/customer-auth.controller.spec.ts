...
describe('Initializing... Customer Auth controller testing', () => {
  ...
  describe('POST /customer/auth/register/send-otp [passing valid req body]', () => {
    it(
      'should return 200 and and return response data',
      async () => {
  ...
  describe('POST /customer/auth/register [passing valid data]', () => {
    it(
      'should return 201 and and return response data',
      async () => {
        return await request(app.getHttpServer())
          .post('/customer/auth/register')
  ...
  describe('POST /customer/auth/sign-in', () => {
    ...
    describe('Customer Authentication', () => {
      it(
        'authenticates customer with valid credentials and provides a jwt token',
        async () => {
      ...
      it(
        'fails to authenticate customer with an incorrect password/email',
        async () => {
          return await request(app.getHttpServer())
            .post('/customer/auth/sign-in')
      ...
      it(
        'fails to authenticate customer without passing email',
        async () => {
          return await request(app.getHttpServer())
            .post('/customer/auth/sign-in')
      ...
      it(
        'fails to authenticate customer without passing password',
        async () => {
          return await request(app.getHttpServer())
            .post('/customer/auth/sign-in')
