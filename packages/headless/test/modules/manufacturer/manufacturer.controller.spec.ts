        ...
        it('should save and return manufacturer response data', async () => {
            const getResult = await request(app.getHttpServer())
                ...
                .expect((res) => {
                    ...
                    expect(res.body.data.message).toEqual("MANUFACTURER_CREATED_SUCCESSFULLY")
        ...
        it('should return manufacturer object with 200 status code', async () => {
            const getResult = await request(app.getHttpServer())
                ...
                .expect((res) => {
                    expect(res.statusCode).toBe(200)
                    expect(res.body.data.manufacturer).toMatchObject(ManufacturerDto)
                    expect(res.body.data.message).toEqual("MANUFACTURER_LOADED_SUCCESSFULLY")
                });
        }, 30000);
    });
        ...
        it('should return manufacturer object with 200 status code', async () => {
            ...
            const getResult = await request(app.getHttpServer())
                ...
                .expect((res) => {
                    ...
                    expect(res.body.data.message).toEqual("MANUFACTURER_UPDATED_SUCCESSFULLY")
                });
        }, 30000);
        ...
        it('should return manufacturer object with 200 status code', async () => {
            const getResult = await request(app.getHttpServer())
                ...
                .expect((res) => {
                    expect(res.statusCode).toBe(200)
                    // expect(res.body.data.manufacturer).toMatchObject(ManufacturerDto)
                    expect(res.body.data.message).toEqual("MANUFACTURER_DELETED_SUCCESSFULLY")
                });
        }, 30000);
    })
