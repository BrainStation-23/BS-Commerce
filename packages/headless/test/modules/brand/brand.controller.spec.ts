...
describe('Initializing Brand controller testing', () => {
  ...
  let brandId = 'ed1b4494-875b-40c3-853c-dfc0776ccd62';
  let brandName = 'Samsung';
  const invalidBrandName = '45454';
  const invalidBrandId = '343434sfsdfsd';
  ...
  beforeAll(async () => {
    ...
    module.get<BrandController>(BrandController);
