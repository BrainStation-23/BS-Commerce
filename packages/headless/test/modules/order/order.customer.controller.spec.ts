...
import { connectTestDatabase, GetDemoUserToken, TestCustomerEmail, TestCustomerId } from '../../test-utility';
import { OrderAdminController } from 'src/modules/order/rest/admin.controlller';
// import { createOrderRequest } from './order.customer.data';

describe('Initializing Order Customer controller testing', () => {
    let app: INestApplication;
    let controller: OrderAdminController;

    const token = GetDemoUserToken(TestCustomerId, TestCustomerEmail, 'customer').token;
