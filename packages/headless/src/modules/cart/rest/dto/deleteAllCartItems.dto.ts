...
import {
  ...
  deleteAllCartItemsErrorResponse,
...
export class deleteAllCartItemsSuccessResponseDto
  implements deleteAllCartItemsSuccessResponse
{
  @ApiProperty()
  @IsNumber()
  code: number;
...
export class deleteAllCartItemsErrorResponseDto
  implements deleteAllCartItemsErrorResponse
{
  @ApiProperty({
