...
export class updateCartItemSuccessResponseDto
  implements updateCartItemSuccessResponse
{
  @ApiProperty()
  @IsNumber()
  code: number;
...
export class updateCartItemErrorResponseDto
  implements updateCartItemErrorResponse
{
  @ApiProperty({
