...
export class deleteCartItemSuccessResponseDto
  implements deleteCartItemSuccessResponse
{
  @ApiProperty()
  @IsNumber()
  code: number;
...
export class deleteCartItemErrorResponseDto
  implements deleteCartItemErrorResponse
{
  @ApiProperty({
