...
export class WishListService {
  ...
  async addToWishList(userId: string, item: Item,): Promise<ServiceSuccessResponse | ServiceErrorResponse> {
    ...
    if (!isWishListExist) {
      ...
      if (!createdWishList) return this.helper.serviceResponse.errorResponse("CAN'T ADD TO WISH LIST", null, HttpStatus.BAD_REQUEST,);
    ...
    if (!isItemExist) {
      ...
      if (!addedItem) return this.helper.serviceResponse.errorResponse("CAN'T ADD ITEM IN WISH LIST", null, HttpStatus.BAD_REQUEST,);
    ...
    if (!incrementalItem) return this.helper.serviceResponse.errorResponse("CAN'T INCREMENT ITEM IN WISH LIST", null, HttpStatus.BAD_REQUEST,);
  ...
  async getWishList(userId: string,): Promise<ServiceSuccessResponse | ServiceErrorResponse> {
    ...
    if (!wishList) return this.helper.serviceResponse.errorResponse("CAN'T GET WISH LIST", null, HttpStatus.BAD_REQUEST,);
  ...
  async getWishlistById(wishlistId: string,): Promise<ServiceSuccessResponse | ServiceErrorResponse> {
    ...
    if (!wishList) return this.helper.serviceResponse.errorResponse("CAN'T GET SINGLE WISH LIST", null, HttpStatus.BAD_REQUEST,);
    return this.helper.serviceResponse.successResponse(wishList);
  }
  ...
  async deleteWishlistById(wishlistId: string): Promise<ServiceSuccessResponse | ServiceErrorResponse> {
    ...
    if (!wishList) return this.helper.serviceResponse.errorResponse("CAN'T DELETE WISH LIST", null, HttpStatus.BAD_REQUEST,);
    return this.helper.serviceResponse.successResponse(wishList);
  }
  ...
  async updateWishlistItem(item: Item, userId: string,): Promise<ServiceSuccessResponse | ServiceErrorResponse> {
    if (item.quantity && item.quantity > 0) {
      ...
      if (!wishList) return this.helper.serviceResponse.errorResponse("CAN'T UPDATE WISH LIST ITEM", null, HttpStatus.BAD_REQUEST,);
      return this.helper.serviceResponse.successResponse(wishList);
    }

    const wishList = await this.wishListRepo.deleteWishlistItem(userId, item);
    if (!wishList) return this.helper.serviceResponse.errorResponse("CAN'T DELETE WISH LIST ITEM", null, HttpStatus.BAD_REQUEST,);
    return this.helper.serviceResponse.successResponse(wishList);
  }
  ...
  async getWishlistWithoutPopulate(userId: string,): Promise<ServiceSuccessResponse | ServiceErrorResponse> {
    ...
    if (!wishList) return this.helper.serviceResponse.errorResponse(" CAN'T GET WISH LIST WITHOUT POPULATE", null, HttpStatus.BAD_REQUEST,);
    return this.helper.serviceResponse.successResponse(wishList);
  }
  ...
  async deleteAllWishlistItems(userId: string,): Promise<ServiceSuccessResponse | ServiceErrorResponse> {
    ...
    if (!wishList) return this.helper.serviceResponse.errorResponse(" CAN'T DELETE USER WISH LIST ITEMS", null, HttpStatus.BAD_REQUEST,);
    return this.helper.serviceResponse.successResponse(wishList);
  }
}
