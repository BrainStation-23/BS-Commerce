...
export class deleteWishlistItemSuccessResponseDto
  implements deleteWishlistItemSuccessResponse
{
...
export class deleteWishlistItemErrorResponseDto
  implements deleteWishlistItemErrorResponse
{
  @ApiProperty({ default: HttpStatus.BAD_REQUEST })
  code: number;

  @ApiProperty({
    example: deleteWishlistItemErrorMessage.CAN_NOT_DELETE_WISHLIST_ITEM,
  })
