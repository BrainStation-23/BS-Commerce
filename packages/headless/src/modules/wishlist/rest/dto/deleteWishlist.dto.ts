...
class SuccessMessage {
  @ApiProperty({
    example: deleteWishlistSuccessMessage.WISHLIST_DELETED_SUCCESSFUL,
  })
  message: string;
}

export class deleteWishlistSuccessResponseDto
  implements deleteWishlistSuccessResponse
{
...
export class deleteWishlistErrorResponseDto
  implements deleteWishlistErrorResponse
{
