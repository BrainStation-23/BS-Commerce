...
export class ProductResolver {
  ...
  @Mutation()
  async updateProductsForBands(@Args('productIds') productIds: string[], @Args('brandId') brandId: string) {
    return await this.productService.updateProductsForBands(productIds, brandId);
  }
}
