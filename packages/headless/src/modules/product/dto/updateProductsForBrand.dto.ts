...
export class UpdateProductsForBrandErrorResponseDto implements UpdateProductsForBrandErrorResponse {
    @ApiProperty({ default: HttpStatus.BAD_REQUEST })
    @IsNumber()
    code: number;

    @ApiProperty({ example: UpdateProductsForBrandErrorMessages.CAN_NOT_UPDATE_PRODUCTS, })
    @IsString()
...
export class UpdateProductsForBrandSuccessResponseDto implements UpdateProductsForBrandSuccessResponse {
