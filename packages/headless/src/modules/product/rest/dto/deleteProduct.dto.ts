...
export class DeleteProductErrorResponseDto
  implements DeleteProductErrorResponse
{
...
class DeleteProductMessage {
  @ApiProperty({
    example: DeleteProductSuccessMessage.PRODUCT_DELETED_SUCCESSFUL,
  })
  @IsString()
  message: DeleteProductSuccessMessage.PRODUCT_DELETED_SUCCESSFUL;
}

export class DeleteProductSuccessResponseDto
  implements DeleteProductSuccessResponse
{
