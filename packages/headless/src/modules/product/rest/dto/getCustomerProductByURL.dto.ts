...
export class GetCustomerProductByURLErrorResponseDto implements GetCustomerProductByURLErrorResponse {
    @ApiProperty({ default: HttpStatus.BAD_REQUEST })
    @IsNumber()
    code: number;

    @ApiProperty({ example: GetCustomerProductByURLErrorMessages.CAN_NOT_GET_PRODUCT, })
    @IsString()
...
export class GetCustomerProductByURLSuccessResponseDto implements GetCustomerProductByURLSuccessResponse {
