...
export class UpdateProductErrorResponseDto
  implements UpdateProductErrorResponse
{
...
export class UpdateProductSuccessResponseDto
  implements UpdateProductSuccessResponse
{
