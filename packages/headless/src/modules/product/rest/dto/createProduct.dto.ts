...
export class CreateProductErrorResponseDto
  implements CreateProductErrorResponse
{
...
export class CreateProductSuccessResponseDto
  implements CreateProductSuccessResponse
{
