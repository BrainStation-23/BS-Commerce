...
export class GetProductCountErrorResponseDto
  implements GetProductCountErrorResponse
{
...
export class GetProductCountSuccessResponseDto
  implements GetProductCountSuccessResponse
{
