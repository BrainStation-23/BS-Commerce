...
export class OrderAdminService {
  ...
  async getOrderStatistics(): Promise<IServiceResponse<OrderStatEntity>> {
    ...
    return errorResponse(
      'Error in order statistics',
      null,
      HttpStatus.BAD_REQUEST,
    );
  }

  async getIncompleteStatistics(): Promise<
    IServiceResponse<OrderIncompleteStatEntity>
  > {
    ...
    return errorResponse(
      'Error in order incomplete statistics',
      null,
      HttpStatus.BAD_REQUEST,
    );
  }
  ...
  async getOrderList(
    ...
    skip?: number,
    limit?: number,
  ): Promise<IServiceResponse<AllOrdersEntity>> {
