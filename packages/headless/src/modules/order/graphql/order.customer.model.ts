import { ObjectType, Field , Int, InputType, PartialType, OmitType, IntersectionType} from '@nestjs/graphql';
...
export class OrderResponseSingleUser extends OmitType(OrderResponse, ['userId'] as const){}
