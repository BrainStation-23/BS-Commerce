...
import { Ancestor, Category, CategoryMeta, createCategoryRequest, getCategoryBySlugRequest, getCategoryRequest, NestedCategoryList, Photo } from "models";
...
@InputType()
export class getCategoryBySlugRequestSchema implements getCategoryBySlugRequest {
    @Field()
    slug: string;
}
