...
import {
  getCategoryListAncestor,
  NestedCategoryList,
  getCategoryListErrorMessage,
  getCategoryListErrorResponse,
...
export class getCategoryListSuccessResponseDto
  implements getCategoryListSuccessResponse
{
  @ApiProperty()
  @IsNumber()
  code: number;
...
export class getCategoryListErrorResponseDto
  implements getCategoryListErrorResponse
{
  @ApiProperty({
