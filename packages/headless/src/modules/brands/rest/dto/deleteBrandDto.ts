...
import  {DeleteBrandErrorResponse, ErrorMessageDeleteBrand, DeleteBrandSuccessResponse} from 'models';
...
export class DeleteBrandSuccessResponseDto implements DeleteBrandSuccessResponse{
...
export type DeleteBrandResponseDto = DeleteBrandErrorResponseDto | DeleteBrandSuccessResponseDto;