...
export class UpdateBrandErrorResponseDto implements UpdateBrandErrorResponse {
  ...
  @ApiProperty()
  error:
    | ErrorMessageUpdate.INVALID_BRAND_ID
    | ErrorMessageUpdate.CANNOT_UPDATE_BRAND
    | ErrorMessageUpdate.BRAND_ALREADY_EXISTS
    | ErrorMessageUpdate.INFO_OR_META_OBJECT_MISSING;

  @ApiProperty()
  errors: string[];
}

export class UpdateBrandSuccessResponseDto
  implements UpdateBrandSuccessResponse
{
...
export type UpdateBrandResponseDto =
