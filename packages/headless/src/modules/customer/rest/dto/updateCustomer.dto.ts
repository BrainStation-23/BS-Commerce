...
export class UpdateCustomerErrorResponseDto
  implements UpdateCustomerErrorResponse
{
...
export class UpdateCustomerSuccessResponseDto
  implements UpdateCustomerSuccessResponse
{
