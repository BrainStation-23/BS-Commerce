...
export class DeleteCustomerAddressParamsDto
  implements DeleteCustomerAddressParams
{
  @ApiProperty()
  @IsString()
  addressId: string;
...
export class DeleteCustomerAddressErrorResponseDto
  implements DeleteCustomerAddressErrorResponse
{
...
export class DeleteCustomerAddressSuccessResponseDto
  implements DeleteCustomerAddressSuccessResponse
{
