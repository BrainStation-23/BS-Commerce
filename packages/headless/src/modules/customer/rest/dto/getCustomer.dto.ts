...
export class GetCustomerInformationErrorResponseDto
  implements GetCustomerInformationErrorResponse
{
...
export class GetCustomerInformationSuccessResponseDto
  implements GetCustomerInformationSuccessResponse
{
