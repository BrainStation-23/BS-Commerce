import { DescriptiveError, UpdateManufacturerRequest, GetManufacturerErrorResponse, GetManufacturerErrorMessages, GetManufacturerSuccessMessages, UpdateManufacturerSuccessResponse } from '@bs-commerce/models';
