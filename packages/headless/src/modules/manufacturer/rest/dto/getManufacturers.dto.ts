...
export class GetManufacturersErrorResponseDto
  implements GetManufacturersErrorResponse
{
...
class ManufacturersDataDto {
  ...
  @ApiProperty({
    example: GetManufacturersSuccessMessages.MANUFACTURERS_LOADED_SUCCESSFULLY,
  })
  message: GetManufacturersSuccessMessages.MANUFACTURERS_LOADED_SUCCESSFULLY;
}
export class GetManufacturersSuccessResponseDto
  implements GetManufacturersSuccessResponse
{
...
export type GetManufacturersResponseDto =
