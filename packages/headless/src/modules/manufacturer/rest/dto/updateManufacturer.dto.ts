import {
  ...
  UpdateManufacturerErrorResponse,
...
export class UpdateManufacturerErrorResponseDto
  implements UpdateManufacturerErrorResponse
{
...
export class UpdateManufacturerSuccessResponseDto
...
export type UpdateManufacturerResponseDto =
