...
@ObjectType({ description: 'Get all manufacturers count in number' })
export class ManufacturersCountResponse {
  @Field({ nullable: true })
  error?: string;
  ...
  @Field(type => ManufacturersCount, { nullable: true })
