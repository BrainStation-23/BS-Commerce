...
export class CustomerSignInErrorResponseDto
  implements CustomerSignInErrorResponse
{
...
export class CustomerSignInSuccessResponseDto
  implements CustomerSignInSuccessResponse
{
