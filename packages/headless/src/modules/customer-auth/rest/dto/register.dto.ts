...
export class CreateCustomerErrorResponseDto
  implements CreateCustomerErrorResponse
{
...
export class CreateCustomerMessage {
  @ApiProperty({
    example: CreateCustomerSuccessMessages.CUSTOMER_CREATED_SUCCESSFUL,
  })
  @IsString()
  message: CreateCustomerSuccessMessages.CUSTOMER_CREATED_SUCCESSFUL;
}

export class CreateCustomerSuccessResponseDto
  implements CreateCustomerSuccessResponse
{
