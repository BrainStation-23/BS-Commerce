...
var modules = [];
var menus;
var allMenus = [], menusArray, curBranch;;
var middleware = {
    before: {},
    after: {}
};
...
Meanio.prototype.Menus = function() {
    var tree = function(menus, allMenus, opt) {
        curBranch = menus.shift();
        var MenuItem;
        if ( allMenus.some(function(obj) { if (obj['name'] === curBranch) { MenuItem = obj; return true; } return false; }) )
            allMenus = MenuItem;
        allMenus[curBranch] = allMenus[curBranch] || []        
        if (menus[0])
            tree(menus, allMenus[curBranch], opt);
        else
            allMenus[curBranch].push(opt);
        return allMenus;
    };
    ...
    this.add = function(options) {
        ...
        options.forEach(function(opt) {
            ...
            menusArray = opt.menu.split('.');
            allMenus = tree(menusArray, allMenus, opt);
        });
        return menus;
    };
