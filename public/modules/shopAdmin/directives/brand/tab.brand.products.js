...
angular.module('shopAdmin').directive('tabBrandProducts', ['$http', '$stateParams', '$state', 'productService',
    function ($http, $stateParams, $state, productService) {
        return {
            restrict: 'AE',
            replace: true,
            templateUrl: 'modules/shopAdmin/views/brand/template/tab-brand-products.html',
