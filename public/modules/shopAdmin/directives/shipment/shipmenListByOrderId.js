...
angular.module('shopAdmin').directive('shipmentListByOrderId', ['$stateParams', 'shipmentService', 'orderService',
    function($stateParams, shipmentService, orderService) {
        return {
            restrict: 'AE',
            replace: true,
            templateUrl: 'modules/shopAdmin/views/shipment/shipment-list-by-order-id.html',
