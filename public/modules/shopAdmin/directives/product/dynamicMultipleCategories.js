...
angular.module('shopAdmin').directive('dynamicMultipleCategories', ['Global', '$http',
    function (Global, $http) {
        return {
            restrict: 'AE',
            replace: false,
            scope: true,
            templateUrl: 'modules/shopAdmin/views/product/template/dynamic-multiple-categories.html',
